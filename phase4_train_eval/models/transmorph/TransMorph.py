...
class TransMorph(nn.Module):
    def __init__(self, config):
        '''
        TransMorph Model (original, full-resolution)
        '''
        ...
        self.up4 = DecoderBlock(embed_dim//2, config.reg_head_chan, skip_channels=config.reg_head_chan if if_convskip else 0, use_batchnorm=False)
...
CONFIGS = {
    ...
    'TransMorph-4-LVL': configs.get_3DTransMorph_config(),
}
